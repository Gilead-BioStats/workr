...
#' @param lSpec `list` a data specification containing required columns.
#' @param lMeta `list` a named list of meta data.
#'
#' @return `list` containing the results of the `lStep$name` function call.
#'
#' @examples rlang::is_installed(c("glue"))
