...
[{gsm} framework](https://gilead-public.github.io/gsm.core/index.html)
for risk-based quality monitoring (RBQM). The {gsm} team developed a
[stable, reusable model for generating
metrics](https://gilead-public.github.io/gsm.core/articles/DataAnalysis.html)
...
- [`workr::RunStep()`](https://gilead-public.github.io/workr/dev/reference/RunStep.md) -
  execute a single workflow step
- [`workr::RunWorkflow()`](https://gilead-public.github.io/workr/dev/reference/RunWorkflow.md) -
  execute a workflow specification (YAML)
- [`workr::RunWorkflows()`](https://gilead-public.github.io/workr/dev/reference/RunWorkflows.md) -
...
workflow. -
[`workr::MakeWorkflowList()`](https://gilead-public.github.io/workr/dev/reference/MakeWorkflowList.md)
...
Use
[`workr::RunProject()`](https://gilead-public.github.io/workr/dev/reference/RunProject.md)
...
📦 [Demo snapshot
(`ss-demo`)](https://github.com/Gilead-Public/workr/tree/ss-demo) —
...
[`workr::DemoApp_init()`](https://gilead-public.github.io/workr/dev/reference/DemoApp_init.md)
