...
format:
  revealjs:
    theme: black
    css: styles.css
    footer: "[gilead-biostats.github.io/workr/](https://gilead-biostats.github.io/workr/)"
    slide-number: true
    hash: true
    transition: none
...
## Configuration, not code {.full-image-slide}
...
<p class="img-caption">Run the pipeline yourself — <a href="https://zeloszhu.com/workr_demoapp/">zeloszhu.com/workr_demoapp</a></p>
