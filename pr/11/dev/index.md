...
TODO add a simple example of chaining workflows. Add a note about
`priority` parameter.
...
[`workr::RunWorkflows()`](https://gilead-biostats.github.io/workr/dev/reference/RunWorkflows.md).
`workr::RunProject` calls
[`workr::RunWorkflows()`](https://gilead-biostats.github.io/workr/dev/reference/RunWorkflows.md)
for every sub-directory in a given location starting with a single
`lData` object.
