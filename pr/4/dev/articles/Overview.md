...
- Raw → SDTM ([gsm +
  sdtm.oak](https://gilead-biostats.github.io/workr/dev/articles/gsm_SDTM_example)):
...
- SDTM → ADaM ([gsm +
  admiral](https://gilead-biostats.github.io/workr/dev/articles/gsm_ADAM_example)):
...
- ADaM → TFLs ([gsm + gtsummary +
  safetyCharts](https://gilead-biostats.github.io/workr/dev/articles/gsm_visualizations)):
...
- ADaM → ARS ([gsm +
  cards](https://gilead-biostats.github.io/workr/dev/articles/gsm_ARS_example)):
