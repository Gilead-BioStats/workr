...
By chaining steps together, you build complex pipelines from simple,
reusable components.

## Composable Workflows

Workflows can call other workflows! Use `RunWorkflow` as a step name to
nest workflows:
...
Example workflow YAML files are provided in
[inst/workflows/](https://gilead-biostats.github.io/workr/dev/inst/workflows/): -
[helloworld.yaml](https://gilead-biostats.github.io/workr/dev/inst/workflows/helloworld.yaml) -
simple single-step workflow -
[two_steps.yaml](https://gilead-biostats.github.io/workr/dev/inst/workflows/two_steps.yaml) -
multi-step workflow -
[cars.yaml](https://gilead-biostats.github.io/workr/dev/inst/workflows/cars.yaml) -
regression example
