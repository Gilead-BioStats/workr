...
## {workr} workflows are `lists` saved as YAML files
...
## <above> {gsm} extensions </above> Robust Reporting and Visualization Layer
...
- GitHub repo for each study
  - Clone default workflows
  - Customize as needed
- `workr::runProject()` runs folders of workflows
  - Monthly or as needed
  - Outputs saved to preferred location (folder, database, S3, etc.)

## Core {gsm} snapshot

![](images/data_analysis.png)

[workr explorer](https://gilead-biostats.github.io/workr/dev/explorer/)
...
A web-based interface for exploring and running {workr} workflows across packages, with user authentication and role-based access control.