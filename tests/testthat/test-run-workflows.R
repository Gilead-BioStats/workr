...
test_that("Example workflows run as expected", {
  ...
  hw <- yaml::read_yaml(system.file("workflows", "00_Example", "helloworld.yaml", package = "workr"))
  ts <- yaml::read_yaml(system.file("workflows", "00_Example", "two_steps.yaml", package = "workr"))
  carswf <- yaml::read_yaml(system.file("workflows", "00_Example", "cars.yaml", package = "workr"))
