...
Use `lConfig$gsm.datasim` to tune the simulated study. Common fields include `participants`, `sites`, `snapshot_count`, `months_duration`, `snapshot`, `profile`, and `study_type`. For longitudinal settings, the provider returns the latest snapshot by default, or the snapshot selected by `lConfig$gsm.datasim$snapshot`.
