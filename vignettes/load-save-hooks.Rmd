...
Install or update the optional dependency from the `dev` branch before running the example locally:
...
```{r gsm-datasim, eval = requireNamespace("gsm.datasim", quietly = TRUE)}
